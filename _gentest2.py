...
def main():
	...
	spec = {
			'test2/questions/all.txt': 25,
	}
	l = LatexTestWriter()
	la = LatexAnswersWriter()
	t = Test(date=u'15.07.2007г.', title=u'Програмиране с Python', subtitle=ur'Тест \No2, Вариант '+var)
	t.questions = genTest(spec, Reader, noreorder=False, noshuffle=False)
